/* ===============================
   i18n FR/EN — Hassen Portfolio
   =============================== */

const dict = {
  fr: {
    doc_title: "Hassen — CV / Portfolio",
    meta_desc: "CV / Portfolio de Hassen : compétences, projets, parcours, hobbies et objectifs.",
    ...
    hero_pill: "CV interactif • HTML/CSS • Animations ✨",
    hero_photo_alt: "Photo de Hassen",
    hero_hi: "Salut, moi c'est",
    hero_typing: "Créatif + Tech",
    hero_lead:
      "J'aime construire des projets (web, code, lore) et apprendre en continu. Ici tu retrouves mon profil, mes compétences, mes projets, et en bas mes hobbies + objectifs 🎯",
    hero_btn_projects: "Voir mes projets",
    hero_btn_contact: "Me contacter",

    stat_num_1: "Unity",
    stat_label_1: "Projets créatifs",
    stat_num_2: "C / Web",
    ...
    profile_role: "Profil polyvalent • Créatif • Développeur en progression 🚀",
    chip_rpi: "Raspberry Pi",
    chip_writing: "Écriture",
    profile_loc: "Localisation",
    profile_loc_value: "France 🇫🇷",
    profile_avail: "Disponibilité",
    profile_avail_value: "À votre service !",
    profile_email: "Email",

    about_title: "À propos",
    about_sub: "Quelques lignes pour expliquer qui je suis, ce que je fais, ce que j'aime 🔥",
    about_profile_title: "Mon profil",
    about_profile_p:
      "Très curieux et créatif : je mélange le code, les projets techniques, et l'écriture d'univers. J'aime apprendre, tester, itérer, améliorer mes idées et surtout découvrir !",
    about_li_1: "💡 Créativité : écriture, lore, idées, narration",
    about_li_2: "🛠️ Technique : C, scripts, Raspberry Pi, web",
    about_li_3: "📈 Progression : rigueur, apprentissage, découverte",
    about_seek_title: "Ce que je cherche",
    about_seek_p:
      "Des projets où je peux être utile, progresser, et construire quelque chose de solide avec une touche de style et d'identité. Comme dirait Vegeta : « Un super guerrier n'abandonne jamais. » 😏",
    about_tag_1: "Développement",
    about_tag_2: "Création",
    about_tag_3: "Systèmes & UI",
    ...
    skills_web_hint: "Niveau : en progression 📈",
    ...
    skills_code_hint: "Niveau : en progression 🧠",
    skills_crea_title: "Créatif",
    skills_crea_li1: "Développement de lore & univers narratifs",
    skills_crea_li2: "Worldbuilding & systèmes",
    skills_crea_li3: "Branding / identité visuelle",
    skills_crea_hint: "Niveau : très à l'aise ✍️",

    projects_title: "Projets",
    projects_sub: "Une sélection de mes projets personnels et professionnels 💪",
    badge_tech: "Tech",
    badge_crea: "Créatif",
    badge_web: "Web",
    proj_rpi_title: "Raspberry Pi LCD",
    proj_rpi_p: "Affichage de texte / menus / interactions sur écran LCD, logique C, GPIO, etc.",
    proj_universe_title: "Univers narratif",
    proj_universe_p: "Construction d'un univers, personnages, lore, systèmes magiques et narration.",
    ...
    obj_li_3: "🧠 Renforcer la résilience mentale",
    obj_li_4: "🚀 Publier / présenter mes projets proprement",
    signature_label: "Phrase signature :",
    signature_quote: "“Construire, apprendre, affiner.”",

    lang_spoken: "Langues parlées",
    ...
    lang_discovery: "Découverte",

    contact_title: "Contact",
    contact_sub: "Mon profil vous plaît ? Parlons-en 👀",
  ...
  en: {
    doc_title: "Hassen — CV / Portfolio",
    meta_desc: "Hassen’s CV / portfolio: skills, projects, experience, hobbies and goals.",
    ...
    hero_pill: "Interactive CV • HTML/CSS • Animations ✨",
    hero_photo_alt: "Photo of Hassen",
    hero_hi: "Hi, I'm",
    hero_typing: "Creative + Tech",
    hero_lead:
      "I love building projects (web, code, lore) and learning continuously. Here you’ll find my profile, skills, projects, and at the bottom my hobbies + goals 🎯",
    ...
    profile_role: "Versatile profile • Creative • Growing developer 🚀",
    chip_rpi: "Raspberry Pi",
    ...
    about_title: "About",
    about_sub: "A few lines to explain who I am, what I do, and what I love 🔥",
    ...
    about_li_1: "💡 Creativity: writing, lore, ideas, storytelling",
    about_li_2: "🛠️ Tech: C, scripts, Raspberry Pi, web",
    about_li_3: "📈 Growth: discipline, learning, exploration",
    about_seek_title: "What I’m looking for",
    about_seek_p:
      "Projects where I can be useful, grow, and build something solid with a touch of style and identity. As Vegeta would say: “A true warrior never gives up.” 😏",
    ...
    skills_crea_hint: "Level: very comfortable ✍️",

    projects_title: "Projects",
    projects_sub: "A selection of my personal and professional projects 💪",
    badge_tech: "Tech",
    badge_crea: "Creative",
    badge_web: "Web",
    proj_rpi_title: "Raspberry Pi LCD",
    ...
    obj_li_3: "🧠 Build mental resilience",
    obj_li_4: "🚀 Publish / present my projects cleanly",
    signature_label: "Signature line:",
    signature_quote: "“Build, learn, refine.”",
    ...
    contact_title: "Contact",
    contact_sub: "Like my profile? Let’s talk 👀",
